 ...
 * Не рассматриваем память, необходимую для хранения ввода
 *
 * Для того, чтобы сохранить все элементы обратной польской нотации в массиве нам потребуется O(n) памяти,
