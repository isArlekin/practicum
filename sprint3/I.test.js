...
describe('findMaxKUniversityIds', () => {
  it('should return k ids in decreasing order', () => {
    expect(findMaxKUniversityIds([1, 2, 3, 1, 2, 3, 4], 3)).toEqual([1, 2, 3]);
    ...
    // expect(findMaxKUniversityIds(arr, 13)).toEqual("2823 1750 6600 5518 3753 5920 7920 7336 4458 8197 1161 2134 983".split(' '));
  });
